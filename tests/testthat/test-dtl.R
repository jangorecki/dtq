...
test_that("dtl expected data types", {
  ...
  expected_r <- structure(c("integer", "integer", "integer", "list", "list", "character", "double", "character", "double", "integer", "integer"),
                          .Names = c("seq", "dtq_id", "dtq_seq", "dtq", "dtq_call", "query", "timestamp", "env", "elapsed", "in_rows", "out_rows"))
